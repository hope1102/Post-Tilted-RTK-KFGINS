...
if __name__ == '__main__':
    ...
    # 导航结果和导航误差
    navresult_filepath = r'D:\GNSS_INS_VISION\KF-GINS-main\dataset\KF_GINS_Navresult.nav'
    refresult_filepath = r'D:\GNSS_INS_VISION\KF-GINS-main\dataset\truth.nav'
    # 导航结果
    ...
    # 估计的IMU误差
    imuerr_filepath = r'D:\GNSS_INS_VISION\KF-GINS-main\dataset\KF_GINS_IMU_ERR.txt'
    # plotIMUerror(imuerr_filepath)

    # 估计的导航状态标准差和IMU误差标准差
    std_filepath = r'D:\GNSS_INS_VISION\KF-GINS-main\dataset\KF_GINS_STD.txt'
